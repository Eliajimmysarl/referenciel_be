    ...
    try {
            ...
            if($nombreLigne > 0)
            ...
            else
                {
                    ...
                    $datas['composant'][]="Ressource not found";
                }   
